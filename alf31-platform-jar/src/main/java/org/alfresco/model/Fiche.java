...
/**
 * Import ContentModel from Alfresco API
 * This is a hack to make ContentModel available in the same package
 */
class ContentModel extends org.alfresco.model.ContentModel {
}
